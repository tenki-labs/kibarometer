...
//                           2018-2019 (covers the 2019-01-01 data floor).
...
// Floor session for backfill — first session that fully contains data
// posted on or after 2019-01-01 (the /offentlig pillar's data cutoff).
const DEFAULT_FROM_SESSION = "2018-2019";
...
// Walk sessions from `fromSession` back to `toSession` (default 2018-2019,
