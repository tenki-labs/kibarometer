...
export function buildJobsMomentum(
    ...
    const pct =
      headline.ai_count_prev_30d > 0
        ? ((headline.ai_count_30d - headline.ai_count_prev_30d) /
          ...
          100
        : null;
    return { pct, caption: "siste 30 dager vs. forrige 30 dager", windowDays: 30 };
  }
  ...
  if (latest === 0) {
    return { pct: null, caption: "siste 7 dager vs. forrige 7 dager", windowDays: 7 };
  }
  ...
  return { pct, caption: "siste 7 dager vs. forrige 7 dager", windowDays: 7 };
}
